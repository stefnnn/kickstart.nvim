  ...
  { 'Bilal2453/luvit-meta', lazy = true },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- solargraph = {
        --   cmd = { 'solargraph', 'stdio' }, -- Use solargraph with stdio
      ...
      vim.list_extend(ensure_installed, {
        ...
        -- 'eslint', -- Eslint support disabled, using none-ls
      })
...
-- Automatically center screen after page up / page down
vim.api.nvim_set_keymap('n', '<C-d>', '<C-d>zz', { noremap = true, silent = true })
vim.api.nvim_set_keymap('n', '<C-u>', '<C-u>zz', { noremap = true, silent = true })

-- Shortcut to edit my neovim config
vim.api.nvim_create_user_command('EdConf', 'edit ~/.config/nvim/init.lua', {})
